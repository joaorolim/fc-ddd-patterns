...
describe("Order repository test", () => {
  ...
  it("should update a order", async () => {
    ...
    // console.log("orderModel2", orderModel2.toJSON());
  ...
  it("should find a order", async () => {
    ...
    // Comparar valores em vez de instâncias
    expect(JSON.parse(JSON.stringify(orderModel))).toStrictEqual(JSON.parse(JSON.stringify(order))
    );
  });
